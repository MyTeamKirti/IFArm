...
class SellerHomeListAdapter(internal var productList:ArrayList<ProductData1>,
                            internal var onItemClick:OnItemClickListner):
    BaseBindingAdapter(productList) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder {
        context = parent.context
        val binding = CustomSellerhomeRawlayoutBinding.inflate(LayoutInflater.from(context), parent, false)
    ...
    inner class ViewHolder(var mBinding: CustomSellerhomeRawlayoutBinding): BaseViewHolder(mBinding.root){
