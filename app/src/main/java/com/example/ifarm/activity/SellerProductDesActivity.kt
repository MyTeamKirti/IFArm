...
import kotlinx.android.synthetic.main.activity_seller_product_des.*
import kotlinx.android.synthetic.main.custom_toolbar_layout.*

class SellerProductDesActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setStatusBar(this,ContextCompat.getColor(this,R.color.colorPrimary))
        setContentView(R.layout.activity_seller_product_des)
        initialization()
    }
...
//            window.navigationBarColor = activity.resources.getColor(android.R.color.black)
    ...
    private fun onViewClickListener(){
        ...
        buttonProductEdit.setOnClickListener {
            val intent= Intent(this,SellerEditProductActivity::class.java)
