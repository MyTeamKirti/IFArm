...
class CommunityFragment : Fragment(),OnItemClickListner {
    ...
    private fun setAdapter(){
        ...
        rvCommunityList.layoutManager = mLayoutManager1
        val trendingProductAdapter = HomeListAdapter(mProductsList,this,1)
        rvCommunityList.adapter = trendingProductAdapter
    ...
    private fun setProductsData(){
        ...
        val postData1= PostData(mProductDataList2,2)
        val postData2= PostData(mProductDataList1,1)
        val postData3= PostData(mProductDataList3,3)
        val postData4= PostData(mProductDataList4,4)
        val postData5= PostData(mProductDataList5,5)
